...
source=("https://github.com/microsoft/onnxruntime-genai/archive/refs/tags/v${pkgver}.tar.gz")
...
package() {
    ...
    install -Dm644 src/ort_genai.h "$pkgdir/usr/include/ort_genai.h"
    install -Dm644 src/ort_genai_c.h "$pkgdir/usr/include/ort_genai_c.h"
}
